 ...
 * @date 2016年12月6日
 * @time 下午5:15:27
 * @JSONObject get/post JSON 请求；
 */
public class HttpJSONObjectRequestUtil {
	static Logger logger = Logger.getLogger(HttpJSONObjectRequestUtil.class
			.getName());
	...
	public static JSONObject httpGet(String url) {
		...
		try {
			...
			if (response.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
				...
				logger.info("get请求提交失败:" + url + "HttpStatus:"
	...
	public static JSONObject httpPost(String url, JSONObject jsonParam,
		...
		try {
			...
			if (statusCode == 200) {
				...
				logger.info("返回状态码Status：" + statusCode);
			}
		} catch (IOException e) {
